...
import com.project.ecommerce.service.cart.CartService;
import com.project.ecommerce.service.CreditCardService;
import com.project.ecommerce.request.ConfirmCartRequest;
import com.project.ecommerce.repository.ProductRepository;
import com.project.ecommerce.repository.ConfirmedOrderRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public void updateByProductDetails(Long productId, String productDetails) {
    ...
    @Override
    public ConfirmedOrder getConfirmedOrderById(Long id) {
    ...
    @Override
    public int getNumberOfFavorite(Long productId) {
